...
g+"border-radius:"+String(a.borderRadius)+"px;";b=b+"border-radius:"+String(a.borderRadius)+"px;";break;case "circle":g=g+"border-radius: "+String(a.lensSize/2+a.borderSize)+"px;",b=b+"border-radius: "+String(a.lensSize/2+a.borderSize)+"px;"}c.wrap("<div id='mlens_wrapper_"+p+"' />");h=c.parent();h.css({width:c.width()});f=e("<div id='mlens_target_"+p+"' style='"+g+"' class='"+a.lensCss+"'>&nbsp;</div>").appendTo(h);g=e("<img style='display:none;width:auto;height:auto;max-width:none;max-height;none;' src='"+a.imgSrc+"' />").appendTo(h);f.css({backgroundImage:"url('"+
