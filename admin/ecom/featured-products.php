...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/admin/ecom/featured_list.php'))
	$featured = unserialize(file_get_contents($_SERVER['DOCUMENT_ROOT'].'/admin/ecom/featured_list.php'));
